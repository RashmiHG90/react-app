...
export default function TicketForm({dispatch, editingTicket}){
    ...
    //after filling form and processing it we want to clear it
    const clearForm =()=>{
        setTitle('');
        setDescription('');
        setPriority('1');
    ...
    //based on number in priority state below values will be displayed
    ...
    return(
       <form onSubmit={handleSubmit} className='ticket-form'>
        ...
        <div>
            ...
            <textarea type="text" value = {description} className='form-input' onChange={e => setDescription(e.target.value)} />
        </div>
